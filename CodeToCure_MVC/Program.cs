...
using CodeToCure_MVC.Extensions;
...
internal class Program
{
    ...
    restrictedToMinimumLevel: LogEventLevel.Warning
        ...
        {
            CodeToCure_DB_ConnectionModel_10 = builder.Configuration.GetSection(nameof(CodeToCure_DB_ConnectionModel_10)).Get<CodeToCure_DB_ConnectionModel_10>(),
            CodeToCure_DB_ConnectionModel_11 = builder.Configuration.GetSection(nameof(CodeToCure_DB_ConnectionModel_11)).Get<CodeToCure_DB_ConnectionModel_11>(),
            CodeToCure_DB_ConnectionModel_12 = builder.Configuration.GetSection(nameof(CodeToCure_DB_ConnectionModel_12)).Get<CodeToCure_DB_ConnectionModel_12>(),
        };
