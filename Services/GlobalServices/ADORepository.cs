...
namespace Services.GlobalServices
{
    public class ADORepository : IADORepository
    {
        ...
        public string GetDBConnectionString(string Database_Name = "", int Database_ID = 13)
        {
            Database_Name = Database_Name.ToLower();
            string connectionString = "";

            if (Database_Name == "" || Database_Name == AppEnum.Database_Name.CodeToCure)
                if (Database_ID == 10)
                    connectionString = _dbStringCollection1.CodeToCure_DB_ConnectionModel_10.ConnectionString;
                else if (Database_ID == 11)
                    connectionString = _dbStringCollection1.CodeToCure_DB_ConnectionModel_11.ConnectionString;
                else
                    connectionString = _dbStringCollection1.CodeToCure_DB_ConnectionModel_12.ConnectionString;

            else
                connectionString = "Data Source=DESKTOP-L2UK5S8;Initial Catalog=AAMH;Integrated Security=true;TrustServerCertificate=true;MultipleActiveResultSets=true";
            //connectionString = _dbStringCollection1.CodeToCure_DB_ConnectionModel_10.ConnectionString;
        ...
        public int ExecuteNONQuery(string Query, ref List<Dynamic_SP_Params> dynamic_SP_Params, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
        ...
        public int ExecuteNONQuery(string Query, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
        ...
        public int ExecuteNONQuery(string Query, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "", params (string Name, object Value)[] ParamsNameValues)
        {
            List<Dynamic_SP_Params> List_dynamic_SP_Params = new List<Dynamic_SP_Params>();
            Dynamic_SP_Params dynamic_SP_Params = new Dynamic_SP_Params();
        ...
        {
            string Database_Name = AppEnum.Database_Name.CodeToCure;
        ...
        public DataSet ExecuteSelectDS(string Query, ref List<Dynamic_SP_Params> dynamic_SP_Params, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
            DataSet dataSet = new DataSet();
            object? return_obj = null;
        ...
        public DataSet ExecuteSelectDS(string Query, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
            List<Dynamic_SP_Params> dynamic_SP_Params = null;
            return ExecuteSelectDS(Query, ref dynamic_SP_Params, Read_Only, Database_Name, CommandTimeOut, Config_Key);
        }
        public DataSet ExecuteSelectDS(string Query, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "", params (string Name, object Value)[] ParamsNameValues)
        {
            List<Dynamic_SP_Params> List_dynamic_SP_Params = new List<Dynamic_SP_Params>();
            Dynamic_SP_Params dynamic_SP_Params = new Dynamic_SP_Params();
        ...
        public DataTable ExecuteSelectDT(string Query, ref List<Dynamic_SP_Params> dynamic_SP_Params, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
            DataSet dataSet = new DataSet();
        ...
        public DataTable ExecuteSelectDT(string Query, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
            List<Dynamic_SP_Params> dynamic_SP_Params = null;
            return ExecuteSelectDT(Query, ref dynamic_SP_Params, Read_Only, Database_Name, CommandTimeOut, Config_Key);
        }
        public DataTable ExecuteSelectDT(string Query, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "", params (string Name, object Value)[] ParamsNameValues)
        {
            List<Dynamic_SP_Params> List_dynamic_SP_Params = new List<Dynamic_SP_Params>();
            Dynamic_SP_Params dynamic_SP_Params = new Dynamic_SP_Params();
        ...
        public DataRow? ExecuteSelectDR(string Query, ref List<Dynamic_SP_Params> dynamic_SP_Params, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
            DataSet dataSet = new DataSet();
        ...
        public DataRow? ExecuteSelectDR(string Query, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
            List<Dynamic_SP_Params> dynamic_SP_Params = null;
            return ExecuteSelectDR(Query, ref dynamic_SP_Params, Read_Only, Database_Name, CommandTimeOut, Config_Key);
        }
        public DataRow? ExecuteSelectDR(string Query, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "", params (string Name, object Value)[] ParamsNameValues)
        {
            List<Dynamic_SP_Params> List_dynamic_SP_Params = new List<Dynamic_SP_Params>();
            Dynamic_SP_Params dynamic_SP_Params = new Dynamic_SP_Params();
        ...
        public object? ExecuteSelectObj(string Query, ref List<Dynamic_SP_Params> dynamic_SP_Params, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
            object? result = null;
            DataRow? dataRow;
        ...
        public object? ExecuteSelectObj(string Query, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
            List<Dynamic_SP_Params> dynamic_SP_Params = null;
            return ExecuteSelectDR(Query, ref dynamic_SP_Params, Read_Only, Database_Name, CommandTimeOut, Config_Key);
        }
        public object? ExecuteSelectObj(string Query, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "", params (string Name, object Value)[] ParamsNameValues)
        {
            List<Dynamic_SP_Params> List_dynamic_SP_Params = new List<Dynamic_SP_Params>();
            Dynamic_SP_Params dynamic_SP_Params = new Dynamic_SP_Params();
        ...
        public object? ExecuteSelectObjMainDB(string Query, ref List<Dynamic_SP_Params> dynamic_SP_Params, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
            object? result = null;
            result = ExecuteSelectObj(Query, ref dynamic_SP_Params, false, Database_Name, CommandTimeOut, Config_Key);
            return result;
        }
        public object? ExecuteSelectObjMainDB(string Query, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
            List<Dynamic_SP_Params> dynamic_SP_Params = null;
            return ExecuteSelectObj(Query, ref dynamic_SP_Params, false, Database_Name, CommandTimeOut, Config_Key);
        }
        public object? ExecuteSelectObjMainDB(string Query, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "", params (string Name, object Value)[] ParamsNameValues)
        {
            List<Dynamic_SP_Params> List_dynamic_SP_Params = new List<Dynamic_SP_Params>();
            Dynamic_SP_Params dynamic_SP_Params = new Dynamic_SP_Params();
        ...
        public int ExecuteStoreProcedureNONQuery(string SPName, ref List<Dynamic_SP_Params> dynamic_SP_Params, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
            object? return_obj = null;
            int return_int = 0;
        ...
        public int ExecuteStoreProcedureNONQuery(string SPName, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
            List<Dynamic_SP_Params> dynamic_SP_Params = null;
            return ExecuteStoreProcedureNONQuery(SPName, ref dynamic_SP_Params, Database_Name, CommandTimeOut, Config_Key);
        }
        public int ExecuteStoreProcedureNONQuery(string Query, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "", params (string Name, object Value)[] ParamsNameValues)
        {
            List<Dynamic_SP_Params> List_dynamic_SP_Params = new List<Dynamic_SP_Params>();
            Dynamic_SP_Params dynamic_SP_Params = new Dynamic_SP_Params();
        ...
        public DataSet ExecuteStoreProcedureDS(string SPName, ref List<Dynamic_SP_Params> dynamic_SP_Params, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
            DataSet dataSet = new DataSet();
            object? return_obj = null;
        ...
        public DataSet ExecuteStoreProcedureDS(string SPName, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
            List<Dynamic_SP_Params> dynamic_SP_Params = null;
            return ExecuteStoreProcedureDS(SPName, ref dynamic_SP_Params, Read_Only, Database_Name, CommandTimeOut, Config_Key);
        }
        public DataSet ExecuteStoreProcedureDS(string Query, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "", params (string Name, object Value)[] ParamsNameValues)
        {
            List<Dynamic_SP_Params> List_dynamic_SP_Params = new List<Dynamic_SP_Params>();
            Dynamic_SP_Params dynamic_SP_Params = new Dynamic_SP_Params();
        ...
        public DataTable ExecuteStoreProcedureDT(string SPName, ref List<Dynamic_SP_Params> dynamic_SP_Params, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
            DataSet dataSet = new DataSet();
            DataTable dataTable = new DataTable();
            object? return_obj = null;
        ...
        public DataTable ExecuteStoreProcedureDT(string SPName, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
            List<Dynamic_SP_Params> dynamic_SP_Params = null;
            return ExecuteStoreProcedureDT(SPName, ref dynamic_SP_Params, Read_Only, Database_Name, CommandTimeOut, Config_Key);
        }
        public DataTable ExecuteStoreProcedureDT(string Query, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "", params (string Name, object Value)[] ParamsNameValues)
        {
            List<Dynamic_SP_Params> List_dynamic_SP_Params = new List<Dynamic_SP_Params>();
            Dynamic_SP_Params dynamic_SP_Params = new Dynamic_SP_Params();
        ...
        public DataRow? ExecuteStoreProcedureDR(string SPName, ref List<Dynamic_SP_Params> dynamic_SP_Params, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "", bool isSP = true)
        {
            DataSet dataSet = new DataSet();
            DataRow? dataRow = null;
            object? return_obj = null;
        ...
        public DataRow? ExecuteStoreProcedureDR(string SPName, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
            List<Dynamic_SP_Params> dynamic_SP_Params = null;
            return ExecuteStoreProcedureDR(SPName, ref dynamic_SP_Params, Read_Only, Database_Name, CommandTimeOut, Config_Key);
        }
        public DataRow? ExecuteStoreProcedureDR(string Query, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "", params (string Name, object Value)[] ParamsNameValues)
        {
            List<Dynamic_SP_Params> List_dynamic_SP_Params = new List<Dynamic_SP_Params>();
            Dynamic_SP_Params dynamic_SP_Params = new Dynamic_SP_Params();
        ...
        public object? ExecuteStoreProcedureObj(string SPName, ref List<Dynamic_SP_Params> dynamic_SP_Params, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
            object? result = null;
            DataRow? dataRow;
        ...
        public object? ExecuteStoreProcedureObj(string SPName, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
            List<Dynamic_SP_Params> dynamic_SP_Params = null;
            return ExecuteStoreProcedureObj(SPName, ref dynamic_SP_Params, Read_Only, Database_Name, CommandTimeOut, Config_Key);
        }
        public object? ExecuteStoreProcedureObj(string Query, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "", params (string Name, object Value)[] ParamsNameValues)
        {
            List<Dynamic_SP_Params> List_dynamic_SP_Params = new List<Dynamic_SP_Params>();
            Dynamic_SP_Params dynamic_SP_Params = new Dynamic_SP_Params();
        ...
        public object? ExecuteStoreProcedureObjMainDB(string SPName, ref List<Dynamic_SP_Params> dynamic_SP_Params, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
            object? result = null;
            result = ExecuteStoreProcedureObj(SPName, ref dynamic_SP_Params, false, Database_Name, CommandTimeOut, Config_Key);
            return result;
        }
        public object? ExecuteStoreProcedureObjMainDB(string SPName, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "")
        {
            List<Dynamic_SP_Params> dynamic_SP_Params = null;
            return ExecuteStoreProcedureObjMainDB(SPName, ref dynamic_SP_Params, Database_Name, CommandTimeOut, Config_Key);
        }
        public object? ExecuteStoreProcedureObjMainDB(string Query, string Database_Name = AppEnum.Database_Name.CodeToCure, int CommandTimeOut = 0, string Config_Key = "", params (string Name, object Value)[] ParamsNameValues)
        {
            List<Dynamic_SP_Params> List_dynamic_SP_Params = new List<Dynamic_SP_Params>();
            Dynamic_SP_Params dynamic_SP_Params = new Dynamic_SP_Params();
        ...
        public T ExecuteSelectSQLMap<T>(string Query, bool IsSP, int CommandTimeOut, ref List<Dynamic_SP_Params> List_Dynamic_SP_Params, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, string Config_Key = "") where T : new()
        {
            bool IsList = false;
            if (CommandTimeOut <= 0)
                CommandTimeOut = 2000;
        ...
        public T ExecuteSelectSQLMap<T>(string Query, bool IsSP, int CommandTimeOut, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, string Config_Key = "", params (string Name, object Value)[] ParamsNameValues) where T : new()
        {
        ...
        public T ExecuteSelectSQLMap<T>(string Query, bool IsSP, int CommandTimeOut, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, string Config_Key = "") where T : new()
        {
            List<Dynamic_SP_Params> List_Dynamic_SP_Params = null;
            return ExecuteSelectSQLMap<T>(Query, IsSP, CommandTimeOut, ref List_Dynamic_SP_Params, Read_Only, Database_Name, Config_Key);
        }
        public List<T> ExecuteSelectSQLMapList<T>(string Query, bool IsSP, int CommandTimeOut, ref List<Dynamic_SP_Params> List_Dynamic_SP_Params, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, string Config_Key = "") where T : new()
        {
            bool IsList = true;
            if (CommandTimeOut <= 0)
                CommandTimeOut = 2000;
        ...
        public List<T> ExecuteSelectSQLMapList<T>(string Query, bool IsSP, int CommandTimeOut, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, string Config_Key = "", params (string Name, object Value)[] ParamsNameValues) where T : new()
        {
            List<Dynamic_SP_Params> List_Dynamic_SP_Params = null;
        ...
        public List<T> ExecuteSelectSQLMapList<T>(string Query, bool IsSP, int CommandTimeOut, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, string Config_Key = "") where T : new()
        {
            List<Dynamic_SP_Params> List_Dynamic_SP_Params = null;
            return ExecuteSelectSQLMapList<T>(Query, IsSP, CommandTimeOut, ref List_Dynamic_SP_Params, Read_Only, Database_Name, Config_Key);
        }
        public void ExecuteSelectSQLMapMultiple(string Query, bool IsSP, bool IsList, int CommandTimeOut, ref List<Dynamic_SP_Params> List_Dynamic_SP_Params, ref List<object> listofobject, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, string Config_Key = "")
        {
            if (CommandTimeOut <= 0)
                CommandTimeOut = 2000;
        ...
        public void ExecuteSelectSQLMapMultiple(string Query, bool IsSP, bool IsList, int CommandTimeOut, ref List<object> listofobject, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, string Config_Key = "", params (string Name, object Value)[] ParamsNameValues)
        {
            List<Dynamic_SP_Params> List_Dynamic_SP_Params = null;
        ...
        public void ExecuteSelectSQLMapMultiple(string Query, bool IsSP, bool IsList, int CommandTimeOut, ref List<object> listofobject, bool Read_Only = false, string Database_Name = AppEnum.Database_Name.CodeToCure, string Config_Key = "")
        {
            List<Dynamic_SP_Params> List_Dynamic_SP_Params = null;
            ExecuteSelectSQLMapMultiple(Query, IsSP, IsList, CommandTimeOut, ref List_Dynamic_SP_Params, ref listofobject, Read_Only, Database_Name, Config_Key);
        }
        ...
        public object? Get_SingleRow_Object_Result(string Query, List<Dynamic_SP_Params> _Params, bool IsSP = false)
        {
            object? result = null;
            DataRow? dataRow;
            dataRow = ExecuteStoreProcedureDR(Query, ref _Params, false, AppEnum.Database_Name.CodeToCure, 0, "", IsSP);
            if (dataRow != null)
            {
                if (Information.IsDBNull(dataRow[0]) == false)
                    result = dataRow[0];
        ...
        {
            P_ReturnMessage_Result result = new P_ReturnMessage_Result();
            DataRow DR = ExecuteStoreProcedureDR(Query, ref dynamic_SP_Params_list, false, AppEnum.Database_Name.CodeToCure, 0, "", IsSP)!;
            result.ReturnCode = Convert.ToBoolean(DR["Return_Code"]);
            result.ReturnText = DR["Return_Text"].ToString();
            return result;
        }
